...
class Settings(BaseSettings):
    ...
    telegram_signal_interval_minutes: int = 1
    telegram_signal_check_seconds: int = 60
    telegram_signal_fast_check_seconds: int = 30
    ...
    telegram_signal_cooldown_minutes: int = 60
    telegram_signal_timeframes: str = "15m,1h"
    telegram_signal_timeframe: str = "1h"
    telegram_confirmation_timeframe: str = "4h"
    telegram_trend_timeframe: str = "1d"
    ...
    telegram_hot_symbol_count: int = 24
    telegram_max_scan_symbols: int = 36
    telegram_min_hot_quote_volume: float = 25_000_000.0
    telegram_signal_symbols: str = "XAUUSD,XAGUSD,USOIL,UKOIL,BTCUSDT,ETHUSDT,SOLUSDT,XRPUSDT,DOGEUSDT"
    telegram_market_update_symbols: str = "XAUUSD,XAGUSD,USOIL,UKOIL,BTCUSDT,ETHUSDT,SOLUSDT,XRPUSDT,DOGEUSDT"
